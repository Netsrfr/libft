...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/09/21 10:02:11 by jpfeffer          #+#    #+#             */
/*   Updated: 2016/09/21 10:02:12 by jpfeffer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_mylog_hex(unsigned int num);
...
int					ft_error_handler
					(int error, char *ret1, char *ret2, char *ret3);
char				*ft_itoa_base(long num, int base);
char				*ft_itoa_base_16(long num);
char				*ft_itoa_base_8(long num);
